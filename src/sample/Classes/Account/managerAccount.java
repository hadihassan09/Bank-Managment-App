...
public class managerAccount implements Account {
    ...
    private static AccountType accountType = new AccountType(0);

    public managerAccount(int managerID) {
        this.managerID = managerID;
        this.customerAccounts=getCustomerAccounts();
    }
    ...
    public void addReception(String fn, String mn, String ln, String fa, String sa, String country, String city, String hp, String wp, String email, String username, String password) throws SQLException {
        ...
        CallableStatement statement = databaseConnection.getConnection().prepareCall("{CALL add_reception(?,?,?,?,?,?,?,?,?,?,?,?)}");
    ...
    public int removeReception(int id) throws SQLException {
        CallableStatement statement = databaseConnection.getInstance().getConnection().prepareCall("{CALL removeReception(?,?)}");
